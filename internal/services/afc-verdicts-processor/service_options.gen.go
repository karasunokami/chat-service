...
func WithBackoffExpFactor(opt float64) OptOptionsSetter {
	return func(o *Options) {
		o.backoffExpFactor = opt
	}
}
...
func (o *Options) Validate() error {
	...
	errs.Add(errors461e464ebed9.NewValidationError("backoffExpFactor", _validate_Options_backoffExpFactor(o)))
...
func _validate_Options_backoffExpFactor(o *Options) error {
	if err := validator461e464ebed9.GetValidatorFor(o).Var(o.backoffExpFactor, "min=1.1,max=5"); err != nil {
		return fmt461e464ebed9.Errorf("field `backoffExpFactor` did not pass the test: %w", err)
	}
	return nil
}
