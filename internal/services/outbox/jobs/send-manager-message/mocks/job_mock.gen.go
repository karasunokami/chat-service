...
func (m *MockmessagesRepo) GetFirstProblemMessage(ctx context.Context, problemID types.ProblemID) (*messagesrepo.Message, error) {
	m.ctrl.T.Helper()
...
func (mr *MockmessagesRepoMockRecorder) GetFirstProblemMessage(ctx, problemID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFirstProblemMessage", reflect.TypeOf((*MockmessagesRepo)(nil).GetFirstProblemMessage), ctx, problemID)
}

// GetMessageByID mocks base method.
func (m *MockmessagesRepo) GetMessageByID(ctx context.Context, id types.MessageID) (*messagesrepo.Message, error) {
	m.ctrl.T.Helper()
...
func (mr *MockmessagesRepoMockRecorder) GetMessageByID(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMessageByID", reflect.TypeOf((*MockmessagesRepo)(nil).GetMessageByID), ctx, id)
}
