...
import (
	...
	"github.com/karasunokami/chat-service/internal/store/schema"
...
func init() {
	...
	failedjob.DefaultCreatedAt = failedjobDescCreatedAt.Default.(time.Time)
	...
	job.DefaultCreatedAt = jobDescCreatedAt.Default.(time.Time)
